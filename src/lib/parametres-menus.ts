...
export const REGLAGES_SECTIONS: ParametreSection[] = [
  ...
  },
  {
    ...
    label: "Compta",
    description: "Longueur des numéros de compte, journaux de trésorerie et exercices.",
    ...
    items: [
      ...
      {
        href: "/parametres/comptabilite/journaux",
        label: "Journaux de trésorerie",
        description: "Un journal par compte de trésorerie.",
        permission: "comptabilite.lire",
      },
      {
...
export const REFERENTIEL_SECTIONS: ParametreSection[] = [
  ...
  },
  {
    ...
    label: "Trésorerie",
    description: "Comptes de caisse, banque, mobile monnaie, journaux et modes de paiement.",
    permission: "parametres.gerer",
    groupe: "referentiel",
    items: [],
  },
