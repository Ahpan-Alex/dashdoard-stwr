...
export default function ParametresAffichagePage() {
  return (
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Colonnes des tableaux, types d'affichage et contrainte d'export A4. Les types sont propres à votre compte."
