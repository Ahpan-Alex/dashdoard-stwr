...
const ENTITE_LABELS: Record<ActiviteEntite, string> = {
  ...
  transfert_matiere_of: "Transfert matière OF",
  ...
  operation_tresorerie: "Appro / retrait trésorerie",
...
/** Toutes les créations / modifications / validations (journal d'activité). */
export function JournalToutesActions() {
    ...
    <div>
      ...
      {lignes.length === 0 ? (
        <EmptyState
          ...
          description="Les créations, modifications, suppressions et validations apparaîtront ici."
        />
      ) : (
